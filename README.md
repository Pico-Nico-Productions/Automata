...
3. Create a class that handles the packet in [`/src/main/java/pro/piconico/automata/network/handler/`](/src/main/java/pro/piconico/automata/network/handler/)
...
3. Create a class that handles the packet in [`/src/client/java/pro/piconico/automata/client/network/handler/`](/src/client/java/pro/piconico/automata/client/network/handler/)
