...
public class AutomatoolScreen extends BotDeviceScreen<AutomatoolScreenHandler> {
    public AutomatoolScreen(AutomatoolScreenHandler handler, PlayerInventory inventory, Text title) {
