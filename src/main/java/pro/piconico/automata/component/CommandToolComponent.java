...
public record CommandToolComponent(Optional<BlockPos> selection1, Optional<BlockPos> selection2) {
    ...
    public static final PacketCodec<ByteBuf, CommandToolComponent> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.optional(BlockPos.PACKET_CODEC),
            component -> component.selection1, PacketCodecs.optional(BlockPos.PACKET_CODEC), component -> component.selection2, CommandToolComponent::new);
