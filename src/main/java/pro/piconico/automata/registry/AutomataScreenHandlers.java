...
public class AutomataScreenHandlers {
    public static final ScreenHandlerType<AutomatoolScreenHandler> AUTOMATOOL = register(AutomataRegistry.AUTOMATOOL, AutomatoolScreenHandler::new, ItemStack.PACKET_CODEC);
